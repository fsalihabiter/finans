...
There's more behind the menu: an **AI commentary page** ("What is your portfolio telling
you?") that turns the computed numbers into 3–5 educational cards, an asset-add flow with
transaction history, and scenario / stock-analysis / lessons modules arriving in the
current phase.
