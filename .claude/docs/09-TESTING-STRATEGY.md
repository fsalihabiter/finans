...
| SC-E21 | 16 §6.1, §9.1-M1/M2 | **Kaynak + açılış bloğu:** her yayımlanmış ders **≥1 `Source` bloğu** taşır ("Bu bilgiler nereden geliyor?") **ve** ilk bloğu öğrenme çıktılarını listeleyen açılış bloğudur (≥3 madde); kaynak bloğu da tavsiye/tahmin taramasından geçer | Integration (seed) | [ ] |
