...
| SC-E19 | 15 §6.3, `13` | **Çok set:** eğitim sayfası birden fazla track listeler (ilk track'e sabitlenmiş varsayım kalmaz); her set kendi ilerlemesini gösterir; **hiçbir set kilitli değil** | Bileşen | [ ] |
| SC-E20 | 15 §6.3, §4 | **"Buradan başla" önerisi:** `LiteracyLevel` Başlangıç/ölçülmemiş → Set 0 önerilir, Gelişen+ → Set 1; öneri bir **rozettir**, erişimi engellemez (tavan kapatılmaz) | Bileşen | [ ] |
