...
| SC-E22 | 16 §9.1-M3/M4/M5/M6 | **Müfredat–seed yapısal sözleşmesi:** figür eşiği set bazlı (Set 0 ≥6, diğer ≥2) ve **her figür anahtarı `LessonFigure.tsx` kayıt defterinde tanımlı** (sessizce düşen figür yok); ders başına 9 soru / her zorluktan ≥3 / tam 1 doğru + açıklama; her dersin ≥1 kavramı ve **boşta kavram yok** | Integration (seed) | [ ] |
