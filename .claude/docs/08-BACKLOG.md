...
| ID | Görev | Bağımlılık | Doküman | Durum |
|----|-------|-----------|---------|-------|
| T1.1 | `PortfolioCalculationService` — formüller (saf fonksiyon) | Faz 0 | `02` §2.2, `CLAUDE.md` §6 | [ ] |
| T1.2 | **Birim testleri** (altın test verisi: 40gr/4.546→181.851, +%43) | T1.1 | `06` §4 | [ ] |
