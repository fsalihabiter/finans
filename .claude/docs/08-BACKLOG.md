...
| T6.8 | **`MiniMarkdown` genişletme:** tablo + link desteği (derin içerik için gerekli) — **`dangerouslySetInnerHTML` YİNE YOK** (XSS-güvenli, topluluk içeriği `14` §4-D2). 🔺 **ÖNE ALINDI (2026-07-22):** `Source` bloğundaki kurumsal referansların tıklanabilir olması için önkoşul (`16` §6.1) | — | `15` §2, `16` §6.1, `13` | [ ] |
