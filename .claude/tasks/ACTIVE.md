...
2. **T6.7** — Uyarlanabilir render: seviyeye göre katlama + "Daha derine in"
   (girdi hazır: `LiteracyLevel`; şu an TÜM derinlik katmanları açık gösteriliyor)
3. **T6.9** — `UserConceptMastery` + aralıklı tekrar
