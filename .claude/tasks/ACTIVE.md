...
1. **T1.13** — Web: Holdings tablo/kart + varlık detay
2. **T1.14** — Web: "Varlık Ekle" formu (modal) → POST /holdings
3. (kalan) T1.8 BES ekranı · T1.15 cache · görsel doğrulama (web bitince)
