...
2. **T6.6** — Tanılama testi (8 soru) → `LiteracyLevel`/`RiskAttitude` (T6.7'nin girdisi)
3. **T6.7** — Uyarlanabilir render: seviyeye göre katlama + "Daha derine in"
   (şu an TÜM derinlik katmanları açık gösteriliyor)
