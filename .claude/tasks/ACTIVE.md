...
2. 🔴 **İÇERİK TURU (kullanıcı isteği, sıradaki iş):** bölüm/konu çeşitlendirme ·
   her detaya örneklem · daha çok figür · **zorluk seviyeli test bankası**.
   Yapısal iskelet hazır (T6.10) — içerik bu akışa göre yazılacak.
