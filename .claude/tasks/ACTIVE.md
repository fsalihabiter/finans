...
2. **T6.5** — Katmanlı içerik şeması (`LessonSection.DepthTier/SectionKind` + migration;
   `BodyMarkdown` fallback) — T6.1/T6.7'nin ön koşulu
3. **T6.1** — İlk 5 dersin **L1/L2/L3** gövdeleri + jenerik örnek + tuzak bloğu
