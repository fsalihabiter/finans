...
2. 🔴 **T6.11b — İÇERİK TURU (ders ders):** 2. ders (Çeşitlendirme) Ders 1 zenginliğinde;
   ardından 3-4-5. **Kalıp Ders 1'de kuruldu:** her kavramın ardından işlenmiş örnek,
   anlatım→örnek→tuzak dönüşümü, figür, 3 zorluklu test.
